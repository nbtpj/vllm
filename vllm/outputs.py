...
class RequestOutput:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Result of an engine-resident choice-rank request (see
        # vllm/v1/engine/choice_rank.py); None for ordinary requests.
        self.choice_rank_result = choice_rank_result
